...
import (
	...
	"github.com/dandawong/golang/concurrency/pattern/pool"
)
...
// idCounter provided support for giving each connection a unique id.
var idCounter int32
...
func main() {
	...
	for query := 0; query < maxGoroutines; query++ {
		// Each goroutines needs its own copy of the query
